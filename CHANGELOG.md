...
- **Clusters moved to their own file** — `clusters.yaml`, beside `config.yaml`, now holds your clusters, cluster groups and target selection; `config.yaml` keeps templates and settings.
